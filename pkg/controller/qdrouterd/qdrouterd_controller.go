...
import (
	...
	interconnectedcloudv1alpha1 "github.com/interconnectedcloud/qdrouterd-operator/pkg/apis/interconnectedcloud/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &interconnectedcloudv1alpha1.Qdrouterd{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &interconnectedcloudv1alpha1.Qdrouterd{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileQdrouterd) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &interconnectedcloudv1alpha1.Qdrouterd{}
...
func newPodForCR(cr *interconnectedcloudv1alpha1.Qdrouterd) *corev1.Pod {
