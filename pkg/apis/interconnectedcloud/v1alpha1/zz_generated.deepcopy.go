...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InterconnectPodStatus) DeepCopyInto(out *InterconnectPodStatus) {
	*out = *in
	if in.Ready != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InterconnectPodStatus.
func (in *InterconnectPodStatus) DeepCopy() *InterconnectPodStatus {
	if in == nil {
		return nil
	}
	out := new(InterconnectPodStatus)
	in.DeepCopyInto(out)
	return out
}
